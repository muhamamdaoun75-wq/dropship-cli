...
const FREE_COMMANDS = ['connect', 'status', 'chat', 'scout', 'source', 'doctor', 'config', 'activate']

// Commands that require pro
const PRO_COMMANDS = ['price', 'fulfill', 'guard', 'analyze', 'segment', 'growth', 'support', 'audit', 'intel', 'supplier', 'forecast', 'profit', 'email', 'autopilot']
